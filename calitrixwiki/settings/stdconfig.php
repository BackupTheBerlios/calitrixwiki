...
'title_format'         => "([A-Z\\xc0-\\xde][a-z\\xdf-\\xff]+:)?([A-Za-z0-9\\x80-\\xff_-]+)",
'title_format_search'  => "(?<=\\s|^)([A-Z\\xc0-\\xde][a-z\\xdf-\\xff]+:)?(([A-Z\\xc0-\\xde][A-Za-z0-9\\x80-\\xff]+){2,})(?=\\s|\\.|,|;|:|\$)",
'url_format'           => "http://localhost/dev/calitrixwiki/cwiki.php?page=%1\$s&action=%2\$s",
'url_format_short'     => "http://localhost/dev/calitrixwiki/cwiki.php?page=%1\$s",
'url_root'             => "http://localhost/dev/calitrixwiki",

...
'url_root'          => '%URLROOT%', // root url without trailing slashes
'doc_root'          => '%DOCROOT%', // document root in the servers file system
'url_format'        => '%URLROOT%/cwiki.php?page=%s&action=%s', // usual url format
'url_format_short'  => '%URLROOT%/cwiki.php?page=%s', // short url format (used for internal hyperlinks
'actions_dir'       => '%ACTIONSDIR%', // dir of the action handlers
'lang_dir'          => '%LANGDIR%', // dir where the language files are located
'lib_dir'           => '%LIBDIR%', // libraries directory
'special_dir'       => '%SPECIALDIR%', // special pages
'plugins_dir'       => '%PLUGINSDIR%', // plugins
'themes_dir'        => '%THEMESDIR%', // themes
...
'default_lang'      => '%DEFAULTLANG%',  // default language (code)
...
'mail_from'         => 'noreply@example.com', // email of the mailer

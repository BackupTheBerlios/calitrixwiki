...
<span class="light-grey">{$lang.prefs_prefs_interface_desc}</span><br /><br />

<strong>{$lang.prefs_prefs_language}</strong><br />
<span class="light-grey">{$lang.prefs_prefs_language_desc}</span><br />
...
<span class="light-grey">{$lang.prefs_prefs_theme_desc}</span><br />
<select name="theme">
...
<span class="light-grey">{$lang.prefs_prefs_items_pp_desc}</span><br />
...
<span class="light-grey">{$lang.prefs_prefs_mailing_desc}</span><br /><br />

...
/* $Id: Smarty_Compiler.class.php,v 1.1 2004/08/10 22:46:25 jklose Exp $ */
...
class Smarty_Compiler extends Smarty {
    ...
    function _compile_file($resource_name, $source_content, &$compiled_content)
    {
        ...
        if (count($this->_plugin_info)) {
            ...
            $_plugins_params .= '))';
            $plugins_code = "<?php require_once(SMARTY_DIR . 'corefuncs' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');\nsmarty_core_load_plugins($_plugins_params, \$this); ?>\n";
        ...
        if ($this->_init_smarty_vars) {
            $template_header .= "<?php require_once(SMARTY_DIR . 'corefuncs' . DIRECTORY_SEPARATOR . 'core.assign_smarty_interface.php');\nsmarty_core_assign_smarty_interface(null, \$this); ?>\n";
    ...
    function _compile_insert_tag($tag_args)
    {
        ...
        return "<?php require_once(SMARTY_DIR . 'corefuncs' . DIRECTORY_SEPARATOR . 'core.run_insert_handler.php');\necho smarty_core_run_insert_handler($_params, \$this); ?>" . $this->_additional_newline;
    }
    ...
    function _compile_include_php_tag($tag_args)
    {
        ...
        return "<?php require_once(SMARTY_DIR . 'corefuncs' . DIRECTORY_SEPARATOR . 'core.smarty_include_php.php');\nsmarty_core_smarty_include_php($_params, \$this); ?>" . $this->_additional_newline;
    }
